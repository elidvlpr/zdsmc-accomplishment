...
$columns = array(
    ...
    array(
        ...
        'formatter' => function ($d, $row) {
            return '
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle text-sm text-light " type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            Action
                        </button>
                        <ul class="dropdown-menu">
                            <li>
                                <button class="dropdown-item" 
                                    ...
                                    data-emp_lname="' . iso8859_1_to_utf8($row['emp_lname']) . '" 
                                    data-emp_fname="' . iso8859_1_to_utf8($row['emp_fname']) . '" 
                                    data-emp_mi="' . iso8859_1_to_utf8($row['emp_mi']) . '" 
                                    data-dep_id="' . iso8859_1_to_utf8($row['dep_id']) . '" 
